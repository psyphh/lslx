...
void lslxOptimizer::update_regularizer_value() {
  ...
  if (lambda > DBL_EPSILON) {
    ...
    } else if ((penalty_method == "lasso")|(penalty_method == "ridge")|(penalty_method == "elastic")) {
      for (i = 0; i < n_theta; i++) {
        if (theta_is_pen[i]) {
          regularizer_value_i = 
      ...
      for (j = 0; j < n_theta; j++) {
        ...
        if (lambda > DBL_EPSILON) {
          if (theta_is_free[j]) {
            ...
            if ((penalty_method == "lasso")|(penalty_method == "ridge")|(penalty_method == "elastic")) {
...
void lslxOptimizer::update_numerical_condition() {
  ...
  if (response) {
    ...
    if (idx_is_effective.size() > 0) {
      ...
      if ((penalty_method == "ridge")|(penalty_method == "elastic")) {
        for (i = 0; i < n_theta; i++) {
          if (theta_is_pen[i]) {
