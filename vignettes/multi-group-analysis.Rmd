...
```
Since the homogeneity of latent factor means may not be a reasonable assumtion when examinning imeasurement invariance, the following code relax the assumption of homogeneous latent means
```{r comment = "", message = FALSE}
