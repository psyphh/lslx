...
```{r comment = "", message = FALSE, fig.width = 8, fig.height = 4, dpi=300, out.width=600, out.height=300}
r6_lslx3$extract_coefficient(selector = "bic")
```
```{r comment = "", message = FALSE, fig.width = 8, fig.height = 4, dpi=300, out.width=600, out.height=300}
diag(r6_lslx3$extract_coefficient_acov(selector = "bic"))
```
