...
<<<<<<< HEAD
If any categorical variable is considered as a valid auxiliary variable, user should first transform it to a set of dummy variables (see `model.matrix`).
=======
If any categorical variable ia considered as a valid auxiliary variable, user should transform it as a set of dummy variables first (see `model.matrix`).
...
=======
They are only used after implementing the `fit` related methods.
>>>>>>> 46a5d6cc4222d4056ee87753c4601f3ed13c38cd
```{r comment = "", message = FALSE}
...
For the references, pleases see the Section of Missing Value in `?lslx`
=======
>>>>>>> 46a5d6cc4222d4056ee87753c4601f3ed13c38cd
