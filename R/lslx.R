...
#'
#' \preformatted{$new(model, data, sample_cov, sample_mean, sample_size, group_variable,
#'      reference_group, weight_variable, auxiliary_variable, verbose = TRUE)}
#' \describe{
#' \item{\bold{Arguments}}{
#'
#' }
...
#'      step_size = 0.5, armijo = 1e-5, ridge_cov = 0, ridge_hessian = 1e-4,
